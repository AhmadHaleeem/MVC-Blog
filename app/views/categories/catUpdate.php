...
<div class="container">
    ...
    <form method="POST" action="http://localhost/php_projects/MVC/CategoryController/updateCat" style="margin-top: 60px; border:  1px solid #ccc; padding: 40px">
        ...
        if (isset($catById)) {
            foreach ($catById as $value) {
                ...
                <input type="submit" value="Update" name="update" class="btn btn-primary btn-block text-white">
            <?php
                    }
                }
            ?>
